...
const Subscribe: NextPage = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center py-6 bg-white">
      ...
      (
        <><p className="text-center mb-4">Sign up with your email address to receive news and updates.</p><form className="flex items-center" onSubmit={void handleSubmit(onSubmit)}>
