...
export function NavBar() {
  ...
  return (
    <nav className="max-w-screen sticky left-0 top-0 z-20 w-full border-b border-gray-200 bg-white dark:border-gray-600 dark:bg-gray-900 md:overflow-x-hidden">
