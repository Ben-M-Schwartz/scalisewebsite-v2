    ...
    <div className="max-w-sm rounded-lg border border-gray-200 bg-white shadow dark:border-gray-700 dark:bg-gray-700">
      ...
      <div className="p-5">
        ...
        <form onSubmit={handleSubmit(handleRemove)}>
            <input id='product_id' type='hidden' value = {product.id} {...register('product_id')} />
        <button
          type='submit'
...
const removeProduct: NextPage = () => {
  ...
  return (
    <>
      ...
      <h1 className="mt-12 pl-4 text-4xl text-white">Which product would you like to remove from the website?</h1>
