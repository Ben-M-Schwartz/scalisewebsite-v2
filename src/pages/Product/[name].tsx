                ...
                {!soldOut &&
                  ...
                  /> */}
                      ...
                      <div className="flex flex-row gap-4">
                          ...
                          <button
                            ...
                            className={`mb-2 mr-2 inline-block ${
                              buttonText === "Added to Cart!"
                                ? "w-1/2"
                                : "w-full"
                            } rounded-lg border py-5 text-sm font-medium text-stone-100 hover:bg-stone-100 hover:text-stone-950 md:w-1/2 ${
                        ...
                        {goToCartButton && (
                          <Link
                            className="mb-2 mr-2 flex w-1/2 items-center justify-center rounded-lg border text-center text-sm font-medium text-stone-100 hover:bg-stone-100 hover:text-stone-950"
                            href="/Cart"
                          >
                            Go To Cart
                          </Link>
