...
const Product: NextPage = () => {
    ...
    return (
        ...
        <main className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-b from-[#2e026d] to-[#15162c]">
            {!isUnsubscribed && (
            <>
            <h1 className='text-white'>Are you sure you want to unsubscribe from  the Scalise newsletter?</h1>
            ...
            {isUnsubscribed && (
                ...
                <Link href='/' className='text-white text-xl font-bold hover:underline hover:text-blue-700 active:text-gray-500'>Home</Link></>
            )}
        </main>
        </>
    )
